...
import com.osama.osama.ebookshop.adapters.BooksAdapter;
import com.osama.osama.ebookshop.databinding.ActivityMainBinding;
import com.osama.osama.ebookshop.model.Book;
import com.osama.osama.ebookshop.model.Category;
import com.osama.osama.ebookshop.viewmodel.MainActivityViewModel;
...
public class MainActivity extends AppCompatActivity
{
    ...
    // create a reference to the activity main binding class which is generated by the data binding library
    public ActivityMainBinding activityMainBinding;
    private MainActivityClickHandlers handlers;
    // we need to get the selected category object from the drop down list
    private Category selectedCategory;
    private RecyclerView booksRecyclerview;
    private BooksAdapter booksAdapter;
    // Defining two constants for add and edit request codes, we need to use them with intent to recognize results sepearatly
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainActivityViewModel.getAllCategories().observe(this, new Observer<List<Category>>() {
            ...
            public void onChanged(@Nullable List<Category> categories) {
                ...
                // take the categories data to an arraylist
    ...
    // we can recognize the response using the request code
    @Override
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        super.onActivityResult(requestCode, resultCode, data);

        int selectedCategoryId = selectedCategory.getId();
        // using the data reference we can get the passed intent values from the AddandEditActivity
        if(requestCode==ADD_BOOK_REQUEST_CODE&&resultCode==RESULT_OK)
        {
            // we can write code to add new books here
            Book book = new Book();
